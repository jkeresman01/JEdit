...
public abstract class WelcomePanelDesigner extends JPanel {
  ...
  private void initComponents() {
    ...
    btnOpenProject.addActionListener(
    ...
    pnlMain.add(
        btnOpenProject, new org.netbeans.lib.awtextra.AbsoluteConstraints(710, 130, 120, 30));
    ...
    pnlMain.add(
        spRecentFiles, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 200, 440, 140));
